...
namespace ermeX.Common.ILGeneration
{
    internal static class ILHelper
    {
        ...
        public static TResult CreateInstance<TResult>(Type typeImpl, params object[] parameters)
        {
            ...
            try
            {
                return (TResult) Handlers[key](parameters);
            }
        ...
        private static readonly Dictionary<string,FastInvokeHandler> MethodInvokers=new Dictionary<string,FastInvokeHandler>();
