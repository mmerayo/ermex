...
namespace ermeX.DAL.DataAccess.DataSources
{
	...
	internal class AppComponentDataSource : DataSource<AppComponent>, IAppComponentDataSource,
	                                        IDataAccessUsable<AppComponent>
	{
		...
		public AppComponentDataSource(IDalSettings dataAccessSettings, Guid localComponentId,
		                              IDataAccessExecutor dataAccessExecutor)
		...
		public override void Save(AppComponent entity)
		{
			if (entity.ComponentExchanges != null && entity.ComponentExchanges != entity.ComponentId &&
			    entity.ComponentExchanges != entity.ComponentOwner)
			{
				Debugger.Launch();
