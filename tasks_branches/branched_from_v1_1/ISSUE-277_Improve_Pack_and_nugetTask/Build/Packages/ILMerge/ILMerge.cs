...
namespace ILMerge.MSBuild.Tasks 
{
    ...
    public class ILMerge : Task 
    {
        ...
        public override bool Execute()
        {
            ...
            if(!string.IsNullOrEmpty(TargetAssemblyVersion))
                ILMerger.Version = new Version(TargetAssemblyVersion);
            
            ILMerger.SetTargetPlatform("v4",@"C:\Windows\Microsoft.NET\Framework\v4.0.30319");//todo: change this on demand
        ...
        public virtual string TargetAssemblyVersion { get; set; }
