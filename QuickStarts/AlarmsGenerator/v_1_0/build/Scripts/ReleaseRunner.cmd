...
set outputSourceCodeFolder=%artifactsfolder%\Source
...
set taskId=%1
set msBuildProperties=Configuration=%configuration%;OutputPath="%outputBinFolder%"\;Platform=%buildType%;Optimize=true;BuildReportsFolder="%outputReportsFolder%";TaskIdName="%taskId%"
